...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Tripeaks Adventure puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Tripeaks Adventure categories'],
  alternates: {
