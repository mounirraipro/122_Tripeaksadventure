...
export const metadata: Metadata = {
    ...
    description: 'Read the Tripeaks Adventure Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Tripeaks Adventure terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Tripeaks Adventure. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Tripeaks Adventure at tripeaksadventure.com, you acknowledge that you have read,
                ...
                <p>
                    Tripeaks Adventure provides a free, browser-based game. Tripeaks Adventure is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Tripeaks Adventure is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Tripeaks Adventure — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Tripeaks Adventure or its
                ...
                <p>
                    ...
                    Tripeaks Adventure for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Tripeaks Adventure, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Tripeaks Adventure a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Tripeaks Adventure displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Tripeaks Adventure is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Tripeaks Adventure and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Tripeaks Adventure at our sole
                ...
                <p>
                    ...
                    <strong>legal@tripeaksadventure.com</strong>.
                </p>
            </div>
        </>
    );
